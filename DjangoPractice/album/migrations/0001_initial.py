    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('PM', 'Pop Music'), ('JM', 'Jazz Music'), ('R&B', 'R&B Music'), ('RB', 'Rock Music'), ('CM', 'Country Music'), ('DM', 'Dance Music'), ('HHM', 'Hip Hop Music'), ('Other', 'Other')], max_length=30)),
